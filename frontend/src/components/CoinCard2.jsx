...
function CoinCard2({ coin }) {
  ...
  return (
    <tr className="text-center border-solid border-b-[1px] border-[#eff2f5] text-[0.9rem]">
      ...
      <td className="flex place-items-center py-[20px]  text-gray-700 whitespace-nowrap text-[0.9rem] hover:cursor-pointer sticky left-0 bg-white hover:bg-gray-50 transition-colors " onClick={() => handleClick(coin.id)}>
        <img
          src={coin.thumb }
          alt={coin.name}
